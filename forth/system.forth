\ -*- text -*-
\	System word definitions for SuwaneeForth.
\
\	By Kristopher Johnson
\	This is PUBLIC DOMAIN (see public domain release statement below).
\
\	This file is mostly a copy of jonesforth.f, tweaked as necessary
\	to handle the differences between the SuwaneeForth kernel and the
\	JONESFORTH kernel.  You can use the "diff" utility to find the
\	differences between this file and the original jonesforth.f.
\
\	JONESFORTH CREDITS ----------------------------------------------------------------------
\
...
SuwaneeForth does not support the following words
...
End of words not supported by SuwaneeForth
) ) )
