...
class forthTests: XCTestCase {
    ...
    func testInitialSnapshot() {
        ...
        //XCTAssertNotEqual(0, s.ip, "instruction pointer should be initialized to a nonzero value")
        XCTAssertEqual(s.options.returnStackCharCount, s.rsp, "rsp should be at top of return stack region")
        XCTAssertEqual(s.options.dataStackCharCount, s.sp, "sp should be at top of stack region")
